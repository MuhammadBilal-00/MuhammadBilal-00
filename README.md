...
[![Profile Views](https://komarev.com/ghpvc/?username=MuhammadBilal-00&color=F0A500&style=for-the-badge&label=PROFILE+VIEWS)](https://github.com/MuhammadBilal-00)
...
![SignalR](https://img.shields.io/badge/SignalR-0078D7?style=flat-square&logo=microsoft&logoColor=white)
![SQL Server](https://img.shields.io/badge/SQL_Server-CC2927?style=flat-square&logo=microsoft-sql-server&logoColor=white)
...
ML model trained on **Top 100 SaaS companies (2025)** to predict company valuation using revenue multiples, growth rate & churn. Deployed as an interactive Streamlit app with full EDA.
...
Full-featured book management system with **ASP.NET Core Razor Pages**, Identity authentication, Stripe payments, repository pattern, and separate admin/customer roles.
...
#### 🦇 [Gotham Task Manager](https://github.com/MuhammadBilal-00/Task-Manager-React)

**Batman-themed** gamified task manager in React. Users complete "Missions" to save Gotham City — immersive dark UI with animated components and gamification mechanics.
...
#### ❤️ [Heart Disease Predictor](https://github.com/MuhammadBilal-00/Heart-Disease-Predictor)

Decision tree model for heart disease prediction using the **UCI Cleveland dataset**. Features full Exploratory Data Analysis, visualization suite, and a reproducible R Markdown report.
